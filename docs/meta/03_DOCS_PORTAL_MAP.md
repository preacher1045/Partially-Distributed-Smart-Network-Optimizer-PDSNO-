...
- `docs/meta/02_PROJECT_OVERVIEW.md`
- `docs/foundations/06_use_cases.md`

### 2. Core Architecture

- `docs/foundations/01_architecture.md`
- `docs/foundations/04_controller_hierarchy.md`
- `docs/foundations/03_communication_model.md`
- `docs/foundations/05_dataflow.md`
- `docs/foundations/02_algorithm_lifecycle.md`

### 3. Data And Consistency

- `docs/reference/02_nib_spec.md`
- `docs/reference/03_nib_consistency.md`

### 4. Protocols And APIs

- `docs/reference/01_api_reference.md`
- `docs/architecture/verification/02_controller_validation_sequence.md`
- `docs/architecture/approval_logic/config_approval_logic.md`
- `docs/architecture/device_discovery/device_discovery_sequence.md`
- `docs/architecture/policy_propagation/01_policy_propagation_doc.md`

### 5. Security And Trust

- `SECURITY.md`
- `docs/reference/04_security_model.md`
- `docs/reference/05_threat_model_and_mitigation.md`

### 6. Deployment And Operations

- `QUICK_START.md`
- `docs/reference/06_deployment_guide.md`
...
- `docs/community_checklist/01_support_policy.md`
- `docs/community_checklist/04_release_and_versioning_policy.md`
- `docs/community_checklist/05_lts_and_backport_policy.md`
- `docs/community_checklist/03_governance_model.md`
- `docs/community_checklist/02_community_support_scope.md`
